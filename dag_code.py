...
cp /home/sufian/Documentation.docx .
...
git add data/dawn_news_articles.csv.dvc data/.gitignore data/bbc_articles.csv.dvc dag_code.py Documentation.docx
git commit -m "dvc commit 2"
dvc remote add -d storage gdrive://1sW4tVChibnF_sJ4ZYaYoLY8FqdTmWIVn
git commit .dvc/config -m "Configure remote storage"
dvc push
git remote add origin https://SufianAhmed2654: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@github.com/SufianAhmed2654/i202654_Assignment2.git
git branch -M main
